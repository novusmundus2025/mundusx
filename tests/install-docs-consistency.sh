...
require_line "docs/install-strategy.md" 'npm run test:windows-uat-install'
require_line "docs/install-strategy.md" 'operator-token.dpapi'
require_line "package.json" '"test:windows-uat-install": "powershell -NoProfile -ExecutionPolicy Bypass -File tests/windows-uat-install-smoke.ps1"'
