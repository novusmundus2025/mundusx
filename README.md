...
- [docs/gap-checklist.md](/Users/DBATALL/Documents/aigrid/docs/gap-checklist.md) for the compare-and-contrast list of what is already implemented versus what is still missing
