...
try {
    ...
    gh secret set OPENGPU_RELEASE_SIGNING_PRIVATE_KEY_PEM_B64 --repo $Repo --body-file $privateB64
    gh secret set OPENGPU_RELEASE_SIGNING_PUBLIC_KEY_PEM_B64 --repo $Repo --body-file $publicB64

    Write-Host "releaseSigning: verifying secret names"
    gh secret list --repo $Repo | Select-String -Pattern "OPENGPU_RELEASE_SIGNING_PRIVATE_KEY_PEM_B64|OPENGPU_RELEASE_SIGNING_PUBLIC_KEY_PEM_B64"
