...
- `opengpu start` - create local state if needed, auto-detect the backend, connect locally, ask for contribution level in a compact arrow-key menu, and print a startup summary with the public key
