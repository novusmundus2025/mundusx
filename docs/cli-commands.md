...
- The model commands manage the local model cache manifest and active selection, and they download official open presets from the reviewed catalog before caching or activating them.
